...
const Add = ({token}) => {
  ...
  const [image4,setImage4] = useState(false)
   ...
   const categories = {
      ...
      Kids: {
        Apparel: ["T-Shirts", "Bottomwear", "Winterwear"],
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <div>
              <p className="mb-2">Gift Recipient</p>
              <select
                value={recipient}
                onChange={(e) => {
                  const newRecipient = e.target.value;
                  const availableCategories = Object.keys(categories[newRecipient]);

                  setRecipient(newRecipient);
                  setCategory(availableCategories[0]);
                  setSubCategory(categories[newRecipient][availableCategories[0]][0]);
                }}
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  setSubCategory(categories[recipient][newCategory][0]);
                }}
                className="w-full px-3 py-2"
              >
                {Object.keys(categories[recipient]).map((categoryName) => (
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2"
              >
                {categories[recipient][category]?.map((subCategoryName) => (
        ...
        {category === "Apparel" && (
          <div>
            ...
            <div className="flex gap-3 flex-wrap">
              {apparelSizes[recipient]?.map((size) => (
                <div
                  key={size}
                  onClick={() =>
                    setSizes((prev) =>
